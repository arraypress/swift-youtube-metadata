...
/// including watch, short, embed, Shorts, live, and parameterised URLs.
enum VideoID {
    ...
    /// - Throws: ``YouTubeTranscriptError/invalidVideoId`` if no valid ID can be extracted.
    /// - Returns: The 11-character video ID.
    static func extract(from input: String) throws(YouTubeTranscriptError) -> String {
